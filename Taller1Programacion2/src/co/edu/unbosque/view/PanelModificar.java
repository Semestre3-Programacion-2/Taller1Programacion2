...
public class PanelModificar extends JFrame{
	...
	public PanelModificar() {
		// TODO Auto-generated constructor stub
		 setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
			...
			boton.setActionCommand("botonModificar");
	...
	public JComboBox<String> getCargo_() {
		return cargo_;
	}
	public void setCargo_(JComboBox<String> cargo_) {
		this.cargo_ = cargo_;
	}
